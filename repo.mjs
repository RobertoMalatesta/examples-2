 ...
 * =============================================================================
 */
import { Actual360, BusinessDayConvention, Compounding, DateGeneration, DateExt, DiscountingBondEngine, FixedRateBond, FixedRateBondForward, FlatForward, Frequency, NullCalendar, Period, Position, RelinkableHandle, Schedule, Settings, Thirty360, version } from 'https://cdn.jsdelivr.net/npm/@quantlib/ql@latest/ql.mjs';

describe(`repo example ${version}`, () => {

      const repoSettlementDate = DateExt.UTC('14,February,2000');
      const repoDeliveryDate = DateExt.UTC('15,August,2000');
      const repoRate = 0.05;
      ...
      const bondIssueDate = DateExt.UTC('15,September,1995');
      const bondDatedDate = DateExt.UTC('15,September,1995');
      const bondMaturityDate = DateExt.UTC('15,September,2005');
